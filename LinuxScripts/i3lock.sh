...
# UNSPLASH_DIR="$HOME/Pictures"
UNSPLASH_DIR="$HOME/.cache/i3lock/current"
EFFECT="blur.png"
...
i3lock -t -i "$UNSPLASH_DIR"/$EFFECT \
...
#     $HOME/Documents/dotfiles/LinuxScripts/unsplash.sh > /var/tmp/unsplash.log 2>&1 &
# fi
